...
class Cart(models.Model):
    ...
    tax_fee = models.DecimalField(max_digits=12, default=0, decimal_places=2)
    total = models.DecimalField(max_digits=12, default=0, decimal_places=2)
    country = models.CharField(max_length=100, null=True, blank=True)
...
class CartOrder(models.Model):
    ...
    sub_total = models.DecimalField(max_digits=12, default=0, decimal_places=2)
    tax_fee = models.DecimalField(max_digits=12, default=0, decimal_places=2)
    total = models.DecimalField(max_digits=12, default=0, decimal_places=2)
    initial_total = models.DecimalField(max_digits=12, default=0, decimal_places=2)
    saved = models.DecimalField(max_digits=12, default=0, decimal_places=2)
